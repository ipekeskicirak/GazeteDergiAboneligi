...
namespace GazeteDergiAboneligi
{
    public partial class Dergiler : Form
    {
        ...
        private void Dergiler_Load(object sender, EventArgs e)
        {
            ...
            // TODO: Bu kod satırı 'dataSet3.TUR' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.tURTableAdapter.Fill(this.dataSet3.TUR);

        }

        private void Grd_Dergiler_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
